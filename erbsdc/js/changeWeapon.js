function changeWeapon(type, index) {
	if (type == 'dagger') {				
		...
		weapon_mastery_skill_damage_reduction_percent = 1.5;
		...
		weapon_mastery_skill_damage_reduction_percent = 2;
		...
		weapon_mastery_skill_damage_reduction_percent = 1;
	} else if (type == 'pistol') {				
		weapon = pistol[index];
		weapon_mastery_attack_speed = 3;
		weapon_mastery_extra_normal_attack_damage_percent = 4.5;
		weapon_mastery_skill_damage_reduction_percent = 1.7;
		...
		weapon_mastery_attack_speed = 3;
		weapon_mastery_extra_normal_attack_damage_percent = 4;
		weapon_mastery_skill_damage_reduction_percent = 1.2;
	} else if (type == 'throws') {				
		weapon = throws[index];
		...
		weapon_mastery_extra_normal_attack_damage_percent = 5;
		weapon_mastery_skill_damage_reduction_percent = 1.8;
	} else if (type == 'glove') {				
		weapon = glove[index];
		...
		weapon_mastery_skill_damage_reduction_percent = 3;
	} else if (type == 'guitar') {				
		weapon = guitar[index];
		weapon_mastery_attack_speed = 1.5;
		weapon_mastery_extra_normal_attack_damage_percent = 1.5;
		weapon_mastery_skill_damage_reduction_percent = 2.5;
...
function changeWeapon2(type, index) {
	if (type == 'dagger') {				
		...
		weapon_mastery_skill_damage_reduction_percent2 = 1.5;
	} else if (type == 'twoHandedSword') {				
		...
		weapon_mastery_attack_speed2 = 3;
		weapon_mastery_extra_normal_attack_damage_percent2 = 4;
		weapon_mastery_skill_damage_reduction_percent2 = 1.2;
	} else if (type == 'throws') {				
		...
		weapon_mastery_extra_normal_attack_damage_percent2 = 5;
		weapon_mastery_skill_damage_reduction_percent2 = 1.8;
	} else if (type == 'glove') {				
		weapon2 = glove[index];
		...
		weapon_mastery_skill_damage_reduction_percent2 = 3;
	} else if (type == 'guitar') {				
		weapon2 = guitar[index];
		weapon_mastery_attack_speed2 = 1.5;
		weapon_mastery_extra_normal_attack_damage_percent2 = 1.5;
		weapon_mastery_skill_damage_reduction_percent2 = 2.5;
	} else if (type == 'nunchaku') {				
